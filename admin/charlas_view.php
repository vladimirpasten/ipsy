...
$id_charla = $_GET['id'];
$titulo_charla = $_GET['titulo'];

include "php/model/charlas.php";

$data_ = get_inscritos($id_charla);
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Asistentes a charla <?php print $titulo_charla; ?> </h5>
                    </div>
                    ...
                    <tbody>
                                    ...
                                    <?php foreach ($listUsers as $user){ 
                                        ...
                                        //$link_view = "javascript:user_view( $id);";
                                        ?>
                                        <tr>
                                            <td><?php print $name; ?> </td>
                                            <td><?php print $fono; ?> </td>
        ...
        $(document).ready(function(){
            ...
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'ListadoAsistentes'},
                    {extend: 'pdf', title: 'ListadoAsistentes'},
