...
<head>
    ...
    <title>INSPINIA | Usuarios Aceptados</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="usuarios_aceptados.php">Aceptados</a></li>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tbody>
                                    ...
                                    print "<input type='hidden' id='url_foto' name='url_foto' value='' />";
                                    ...
                                    foreach ($listUsers as $user){ 
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src='<?php print $link_foto;?>' alt='' style='max-width: 68px;max-height: 160px;'/>   

                                        <?php

                                        if ($foto == ""){

                                            print "<div class='cell-sm-5'>";
                                            print "<div class='form-wrap form-wrap-validation'>";

                                            print "                                            <div class='upload_foto' style='height:100px;' id='file_upload_foto_$id'   
                                                 name='upload_foto'> Foto</div>";
                                            print "<a href='javascript:modificar_foto( $id );'  >Guardar</a>";
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                    ...
                                                    <textarea id="txt_<?php print $id; ?>" cols="20" rows="8"><?php print $resumen; ?></textarea>
                                                    <a href="javascript:modificar_resumen( <?php print $id; ?> );"  >Modificar</a>                                                    
                                            </td>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
              ...
              $('.upload_foto').uploadFile({
                  ...
                  url: '../php/ajax/upload_file_foto.php',
...
function modificar_resumen(id){


            $.ajax ({
                  url:        'php/ajax/user_modify.php',  // URL a invocar asíncronamente 
                  type:         'post' ,   // Método utilizado para el requerimiento 
...
function modificar_foto( id ){



            $.ajax ({
                  url:        'php/ajax/user_pic_modify.php',  // URL a invocar asíncronamente 
                  type:         'post' ,   // Método utilizado para el requerimiento 
