          ...
          <div class="range range-60">
            <div class="cell-lg-8">
              <div class="range range-35" id="terapeutas">
                ...
                <iframe src="app02/index.php<?php print $ruta;?>" width="100%" height="1000px"></iframe>
                ...
                <ul class="list-inline list-inline-lg">
                  <li>
                    <ul class="list list-marked list-marked-sm list-marked-primary" style="line-height: 1.2">
                      <li><a class="link-default" href="about.html">¿Qué es Ipsy?</a></li>
                      <li><a class="link-default" href="services.php">Terapias</a></li>
                    </ul>
                  </li>
                  <li>
                    <ul class="list list-marked list-marked-sm list-marked-primary" style="line-height: 1.2">
                      <li><a class="link-default" href="our-doctors.html">Psicólogos</a></li>
