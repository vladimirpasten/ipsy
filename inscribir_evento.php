...
$charla_ = get_charla($evento);

$charla_array = $charla_["array"];
$charla = $charla_array [0]; 

$fecha = $charla["fecha"];
$hora = $charla["hora"];
$name_autor  = $charla["autor"];
$titulo = $charla["titulo"];
$link_pago  = $charla["link_pago"];
...
<html class="wide wow-animation" lang="en">
  <head> 
    <!-- Site Title-->
    <title>Inscripción en Charla</title>
  ...
  <body>
      ...
      <section class="section section-lg bg-white">
        <div class="shell">
          <div class="range range-30">
            ...
            <div class="cell-md-10" id="datos_confirmar" name="datos_confirmar" style="display:block;">
              <div class="form-block">
                <h3>Inscripción en Charla</h3>
                <p>
                  Por favor, Confirme sus datos para dejar inscribir.
                </p>
                <p> Fecha y Hora: <?php print $fecha . " " . $hora;?> <br>
                    Título:    <?php print $titulo;?><br>
                    Autor:     <?php print $name_autor;?>
                  ...
                  <div class="range range-xs-center range-20 range-narrow">
                    ...
                    <div class="cell-sm-10">
                      <div class="form-wrap form-wrap-validation">
                        ...
                        <input class="form-input" id="nombre" type="text" name="nombre" value="">
                  ...
                  <div class="range range-xs-center range-20 range-narrow">
                    ...
                    <div class="cell-sm-10">
                      <div class="form-wrap form-wrap-validation">
                        ...
                        <input class="form-input" id="rut" type="text" name="rut" value="">
                  ...
                  <div class="range range-xs-center range-20 range-narrow">
                    ...
                    <div class="cell-sm-10">
                      <div class="form-wrap form-wrap-validation">
                        ...
                        <input class="form-input" id="email" type="text" name="email" data-constraints="@Email @Required" value="">
            ...
            <div class="cell-md-10"  id="datos_pago" name="datos_pago" >
              <div class="form-block">
                <h3>Inscripción en Charla <?php print $titulo ; ?></h3>
                <p>
                  Por favor, realice el pago para confirmar su inscripción.
                </p>
                  <div class="range range-xs-center range-20 range-narrow">
                    <div class="cell-sm-5">
                    </div>
    ...
    <script type="text/javascript">
      ...
      function confirmar_hora(){
            ...
            $.ajax ({
                  url:        'php/ajax/confirmar_inscripcion.php',  // URL a invocar asíncronamente 
                  type:         'post' ,   // Método utilizado para el requerimiento 
                              
                  data:   {
                    'id_charla': '<?php print $evento;?>',
                    'titulo': '<?php print $titulo;?>',
                  ...
                  success:  function(data)
                  {
                    ...
                    if (data == "OK"){
                        alert("La Inscripción fue confirmada con éxito.");
